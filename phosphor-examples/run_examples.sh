...
function run_example {
  ...
  if [ -d $jre_inst ]
    then
	  ...
	  #echo "$jre_inst/bin/java -Xbootclasspath/a:$phosphor_jar -javaagent:$phosphor_jar -cp $examples_jar $class $rest"
      $jre_inst/bin/java -Xbootclasspath/a:$phosphor_jar -javaagent:$phosphor_jar -cp $examples_jar $class $rest
    else
...
run_example $JRE_OBJ $PHOSPHOR_JAR $EXAMPLES_JAR edu.utd.Test
